import 'models/iphone_14_15_pro_fourteen_model.dart';
...
import 'provider/iphone_14_15_pro_fourteen_provider.dart';

class Iphone1415ProFourteenScreen extends StatefulWidget {
  const Iphone1415ProFourteenScreen({Key? key})
      : super(
          key: key,
        );

  @override
  Iphone1415ProFourteenScreenState createState() =>
      Iphone1415ProFourteenScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => Iphone1415ProFourteenProvider(),
      child: Iphone1415ProFourteenScreen(),
    );
  }
}

class Iphone1415ProFourteenScreenState
    extends State<Iphone1415ProFourteenScreen> {
  @override
  void initState() {
    super.initState();
  }
